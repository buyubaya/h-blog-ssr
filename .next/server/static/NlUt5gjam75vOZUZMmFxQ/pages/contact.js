...
// EXTERNAL MODULE: ./components/HOCs/withBreadcrumb.js + 1 modules
var withBreadcrumb = __webpack_require__("BAFy");
...
// CONCATENATED MODULE: ./apollo/qms.js
...
var JOIN_ROOM_MUTATION = external_graphql_tag_default()(_templateObject()); // MESSAGE

var MESSAGE_QUERY = external_graphql_tag_default()(_templateObject2());
var SEND_MESSAGE_MUTATION = external_graphql_tag_default()(_templateObject3()); // {
//     "from": {
//         "userId": "11111",
//         "userName": "NAME 01"
//     },
...
var MESSAGE_SUBSCRIPTION = external_graphql_tag_default()(_templateObject4()); // {
//     "from": {
//       "userId": ["22222"]
//     },
//     "to": {
...
var USER_STATUS_QUERY = external_graphql_tag_default()(_templateObject5());
var USER_STATUS_MUTATION = external_graphql_tag_default()(_templateObject6());
var USER_STATUS_SUBSCRIPTION = external_graphql_tag_default()(_templateObject7());
...
// CONCATENATED MODULE: ./components/ContactPage/ChatBox.js
...
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(ChatBox, _Component);
  ...
  function ChatBox() {
    ...
    Object(classCallCheck["a" /* default */])(this, ChatBox);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf2 = Object(getPrototypeOf["a" /* default */])(ChatBox)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleMsgTyping", function () {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleMsgTypingStop", external_lodash_["debounce"](function () {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleMsgChange", function (e) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleMsgEnter", function (e) {
      if (e.shiftKey) {
        e.preventDefault();
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "sendMessage", function () {
      var msgText = _this.state.msgText;
  ...
  Object(createClass["a" /* default */])(ChatBox, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("div", {
        ...
        className: external_classnames_default()('chatbox-wrapper', chatBoxWrapperClassName)
      ...
      }), title ? title : 'Message', external_react_default.a.createElement(icon_default.a, {
        type: "close",
        ...
        return external_react_default.a.createElement("li", {
          ...
          className: "partner"
        }, item.sender.userName), external_react_default.a.createElement("pre", {
          className: "msg-text"
        }, item.content), external_react_default.a.createElement("span", {
          className: "time"
        }, item.isSending ? 'Sending...' : "Sent ".concat(external_moment_(item.createdAt * 1).format('HH:mm')))));
      }), external_react_default.a.createElement("li", {
        className: "message-row pending"
      }, userTypingList && userTypingList.length > 0 && external_react_default.a.createElement("div", {
        className: "msg v2"
      }, external_react_default.a.createElement("span", {
        className: "partner"
      }, userTypingList.join(',')), external_react_default.a.createElement("div", {
        className: "dot"
      }), external_react_default.a.createElement("div", {
        className: "dot"
      }), external_react_default.a.createElement("div", {
        ...
        title: "Send"
      }), external_react_default.a.createElement("div", null, "Enter")))));
    }
  }]);
...
/* harmony default export */ var ContactPage_ChatBox = (ChatBox_ChatBox);
// CONCATENATED MODULE: ./components/ContactPage/ChatRoom.js
...
var ChatRoom_ChatRoom =
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(ChatRoom, _Component);
  ...
  function ChatRoom() {
    ...
    Object(classCallCheck["a" /* default */])(this, ChatRoom);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf2 = Object(getPrototypeOf["a" /* default */])(ChatRoom)).call.apply(_getPrototypeOf2, [this].concat(args)));

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "unsubscribe", null);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "state", {
      messageList: []
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleMessageSend", function (msgText) {
      ...
      var sendToRoomId = external_lodash_["get"](sendTo, 'receiver.roomId');

      if (sendToRoomId) {
        external_lodash_["set"](sendTo, 'receiver.roomId', [].concat(_toConsumableArray(sendToRoomId), [roomId]));
      } else {
        external_lodash_["set"](sendTo, 'receiver.roomId', [roomId]);
      }

      variables = Object(objectSpread["a" /* default */])({}, variables, {
      ...
      _this.setState(function (state) {
        return {
          messageList: [].concat(_toConsumableArray(state.messageList), [Object(objectSpread["a" /* default */])({}, variables, {
            isSending: true
          })])
        };
      });
      ...
      return sendMessage && sendMessage({
        ...
        _this.setState(function (state) {
          ...
          var newMessageList = _toConsumableArray(state.messageList);

          newMessageList[tmp] = Object(objectSpread["a" /* default */])({}, newMessage, {
            isSending: false
          });
          return {
            messageList: _toConsumableArray(newMessageList)
          };
        });
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleMessageTyping", function () {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleMessageTypingStop", function (msgText) {
  ...
  Object(createClass["a" /* default */])(ChatRoom, [{
    ...
    value: function componentDidMount() {
      ...
      var listenToReceiverRoomId = external_lodash_["get"](listenTo, 'receiver.roomId');

      listenTo = listenTo ? listenTo : {};

      if (listenToReceiverRoomId) {
        external_lodash_["set"](listenTo, 'receiver.roomId', [].concat(_toConsumableArray(listenToReceiverRoomId), [roomId]));
      } else {
        external_lodash_["set"](listenTo, 'receiver.roomId', [roomId]);
      }
      ...
      this.unsubscribe = [msgSubscribeToMore && msgSubscribeToMore({
        ...
        updateQuery: function updateQuery(prev, _ref) {
          ...
          return assign_default()({}, prev, {
            message: [].concat(_toConsumableArray(prev.message), [newItem])
          });
        }
        ...
        updateQuery: function updateQuery(prev, _ref2) {
          ...
          if (newItem.isTyping) {
            ...
            if (checkExist.length < 1) {
              return assign_default()({}, prev, {
                userStatus: [newItem].concat(_toConsumableArray(prev.userStatus))
              });
            }
    ...
    value: function componentWillReceiveProps(newProps) {
      ...
      var newMessage = external_lodash_["findLast"](messageData, function (item) {
        return external_lodash_["get"](item, 'sender.userId') !== external_lodash_["get"](newProps, 'sender.userId') && !external_lodash_["some"](messageList, function (x) {
    ...
    value: function render() {
      ...
      if (initialMessageList) {
        messageList = [].concat(_toConsumableArray(initialMessageList), _toConsumableArray(messageList));
      } // USER STATUS
      ...
      return external_react_default.a.createElement(ContactPage_ChatBox, {
        title: title,
        sender: sender,
        roomId: roomId,
...
/* harmony default export */ var ContactPage_ChatRoom = (Object(external_react_apollo_["compose"])(Object(external_react_apollo_["graphql"])(MESSAGE_QUERY, {
  name: 'messageQuery',
...
}), Object(external_react_apollo_["graphql"])(SEND_MESSAGE_MUTATION, {
  name: 'sendMessage'
}), Object(external_react_apollo_["graphql"])(USER_STATUS_QUERY, {
...
}), Object(external_react_apollo_["graphql"])(USER_STATUS_MUTATION, {
  name: 'updateUserStatus'
}))(ChatRoom_ChatRoom));
// CONCATENATED MODULE: ./components/ContactPage/ContactMeChatBox.js
...
var ContactMeChatBox_ContactMeChatBox =
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(ContactMeChatBox, _Component);
  ...
  function ContactMeChatBox() {
    ...
    Object(classCallCheck["a" /* default */])(this, ContactMeChatBox);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf2 = Object(getPrototypeOf["a" /* default */])(ContactMeChatBox)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleMessageReceive", function (msg) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleTabClick", function (key, e) {
      _this.setState({
        chatMode: key
      });
    });
  ...
  Object(createClass["a" /* default */])(ContactMeChatBox, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
      ...
      var guest_data = {
        userId: null,
        userName: 'GUEST_' + external_moment_(now_default()()).format('HH:mm:ss'),
        isNew: true
      };
      ...
      joinRoom && joinRoom({
        variables: Object(objectSpread["a" /* default */])({}, guest_data)
      }).then(function (res) {
        var guest = {
          userId: external_lodash_["get"](res, 'data.joinRoom.userId'),
          userName: external_lodash_["get"](res, 'data.joinRoom.userName')
        };
        ...
        _this2.setState({
          ...
          sessionStorage.setItem('chat_guest_user', stringify_default()(guest));
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(ContactPage_ChatRoom, {
        title: roomTitle,
        roomId: roomId,
        sender: sender,
        sendTo: sendTo,
...
/* harmony default export */ var ContactPage_ContactMeChatBox = (Object(external_react_apollo_["compose"])(Object(external_react_apollo_["graphql"])(JOIN_ROOM_MUTATION, {
  name: 'joinRoom'
}))(ContactMeChatBox_ContactMeChatBox));
...
var httpLink = new external_apollo_link_http_["HttpLink"]({
...
var client_link = external_apollo_link_["ApolloLink"].from([terminatingLink]);
var cache = new external_apollo_cache_inmemory_["InMemoryCache"]();
var client = new external_apollo_client_["ApolloClient"]({
  link: client_link,
  cache: cache
});
...
var contact_ContactPage =
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(ContactPage, _Component);
  ...
  function ContactPage() {
    ...
    _this = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf2 = Object(getPrototypeOf["a" /* default */])(ContactPage)).call.apply(_getPrototypeOf2, [this].concat(args)));

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "state", {
      maskPosition: true
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleSwitch", function () {
      _this.setState(function (state) {
        return {
  ...
  Object(createClass["a" /* default */])(ContactPage, [{
    ...
    value: function render() {
      ...
      }, "Say hello to me!"), external_react_default.a.createElement("h3", {
        className: "get-in-touch-subtitle"
      }, "Let's talk business or just have a coffe.")), external_react_default.a.createElement("div", {
        className: "btn-switch",
        onClick: this.handleSwitch
      }, "Switch to Contact")), external_react_default.a.createElement("div", {
        className: "half-area get-in-touch-area"
      }, external_react_default.a.createElement("div", {
        className: "get-in-touch-header"
      }, external_react_default.a.createElement("h2", {
        className: "get-in-touch-title"
      }, "Get in touch!"), external_react_default.a.createElement("h3", {
        className: "get-in-touch-subtitle"
      }, "Always within your reach")), external_react_default.a.createElement("div", {
        className: "btn-switch",
        onClick: this.handleSwitch
      }, "Switch to Chat")))), external_react_default.a.createElement("div", {
        className: "full-area"
      }, external_react_default.a.createElement("div", {
      ...
      }, "Hieu Le"), external_react_default.a.createElement("div", {
        className: "contact-me-header-subtitle"
      }, "Front-end Developer")), external_react_default.a.createElement("div", null, external_react_default.a.createElement("dl", {
        className: "contact-info-item"
      }, external_react_default.a.createElement("dt", null, "Address"), external_react_default.a.createElement("dd", null, "New York City, US")), external_react_default.a.createElement("dl", {
        className: "contact-info-item"
      }, external_react_default.a.createElement("dt", null, "Phone"), external_react_default.a.createElement("dd", null, "0123456789")), external_react_default.a.createElement("dl", {
        className: "contact-info-item"
      }, external_react_default.a.createElement("dt", null, "Email"), external_react_default.a.createElement("dd", null, "hieu.lnd@gmail.com"))))), external_react_default.a.createElement("div", {
        className: "half-area right-half"
      }, external_react_default.a.createElement("div", {
        className: "half-inner"
      }, external_react_default.a.createElement(ContactPage_ContactMeChatBox, null)))))));
    }
  }], [{
    key: "getInitialProps",
    value: function () {
...
/* harmony default export */ var contact = __webpack_exports__["default"] = (Object(external_recompose_["compose"])(Object(withBreadcrumb["a" /* default */])('contact-page'))(contact_ContactPage));
