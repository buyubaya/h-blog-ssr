...
function (_React$Component) {
  ...
  function AboutPage() {
    ...
    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(AboutPage).call(this));
    _this.state = {
      skills: [{
        key: 'html',
        name: 'HTML<br />CSS',
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(AboutPage, [{
    ...
    value: function componentDidMount() {
      ...
      skills.forEach(function (skill, index) {
        setTimeout(function () {
          if (_this2['skill_' + skill.key]) {
            _this2['skill_' + skill.key].style.width = skill.percent + '%';
          }

          if (_this2['circle_' + skill.key]) {
            _this2['circle_' + skill.key].style.strokeDashoffset = 314.159265359 * (100 - skill.percent) / 100;
          }
        }, 500 * index);

        if (skill.infos.length > 0) {
          skill.infos.forEach(function (skillInfo, jndex) {
            setTimeout(function () {
              if (_this2["skill_info_".concat(skill.key, "_").concat(skillInfo.key)]) {
                _this2["skill_info_".concat(skill.key, "_").concat(skillInfo.key)].classList.add('is-active');
              }
            }, 250 * jndex);
          });
        }
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
        ...
        return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
          ...
          className: "skill-point column column-4-md"
        }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
          className: "skill-svg"
        }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
          ...
          ref: function ref(el) {
            return _this3['circle_' + item.key] = el;
          },
          className: "circle-2",
          cx: "50%",
          cy: "50%",
          ...
          ref: function ref(el) {
            return _this3['skill_' + item.key] = el;
          }
        }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("img", {
          className: "skill-icon",
          src: "static/images/".concat(item.img)
        })))), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
          className: "skill-info column column-8-md"
        }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("ul", {
          className: "skill-info-list"
        }, item.infos && item.infos.map(function (info) {
          return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("li", {
            className: "skill-info",
            key: info.key,
            ref: function ref(el) {
              return _this3["skill_info_".concat(item.key, "_").concat(info.key)] = el;
            }
            ...
            className: "skill-info-img"
          }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("img", {
            src: "static/images/".concat(info.img)
          })));
        }))));
      })));
    }
...
/* harmony default export */ __webpack_exports__["default"] = (Object(recompose__WEBPACK_IMPORTED_MODULE_6__["compose"])(Object(_components_HOCs_withBreadcrumb__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])('about-page'))(AboutPage));
